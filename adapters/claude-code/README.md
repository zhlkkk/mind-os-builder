...
```bash
python scripts/install_harness.py claude-code --scope project --project /绝对路径/目标项目
python scripts/install_harness.py claude-code --scope project --project /绝对路径/目标项目 --apply
```
