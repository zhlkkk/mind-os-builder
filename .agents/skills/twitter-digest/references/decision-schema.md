...
提交器还会阻止明显的机械决策：保留项不得把裸 `t.co` 短链作为标题或摘要，40 字以内的标题和摘要不得完全相同；Twitter 保留项的展示标题和摘要都必须包含中文，非中文原文必须声明 `translated: true`，并拒绝“关于……的探讨”“作者分享了如下内容”“核心要点”等机械套壳；候选达到 10 条时，不得全部保留且使用同一个理由。
